...
# current_time = '2020-12-25-09:13:18' # Uncomment for Testing
            ...
            while not done: 
                ...
                if done:
                    if info['was_successful_trajectory']:
                        ...
                        if self.args.mod:
                            reward=10
                        # print("Terminal state reward: %s"%reward)
                    else:
                        success_episodes=0
                ...
                masks = np.random.binomial(1,0.9,self.n_heads) # Masks are for selecting the networks for training on this particular transition
