...
def get_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help='number of forward steps in rollout storage (default: 5)')
    parser.add_argument(
        '--ppo-epoch',
        type=int,
        default=4,
    ...
    parser.add_argument(
        '--env-name',
        default='SEVN-Test-AllObs-Shaped-v1',
        help='environment to train on (default: SEVN-Test-AllObs-Shaped-v1)')
    parser.add_argument(
        '--log-dir',
        default='/tmp/gym/',
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='whether modify the reward function')
    parser.add_argument(
        '--continue-model',
    ...
    # assert args.algo in ['ppo', 'random']
    return args
